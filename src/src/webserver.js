...
let port = nconf.get('port') || process.env.PORT || 8118;
...
((app) => {
  ...
  module.exports.listen = (callback, p) => {
    ...
    server.listen(port, '0.0.0.0', () => {
      winston.info('Writex is now listening on port: ' + port);
  ...
  module.exports.installServer = function (callback) {
    ...
    app.use(favicon(path.join(__dirname, '../public/uploads/assets/favicon.ico')));
