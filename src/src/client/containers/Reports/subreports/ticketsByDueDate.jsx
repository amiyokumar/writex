...
const ReportTicketsByDueDate = () => {
  ...
  const onFormSubmit = e => {
    ...
    dispatch(
      generateReport({
        type: 'tickets_by_due_date',
        filename: `tickets_by_due_date__${moment(due).format('MMDDYYYY')}`,
        //startDate,
        due,
      ...
      <TruCard
        ...
        header={
          <div style={{ padding: '10px 15px' }}>
            <h4 style={{ width: '100%', textAlign: 'left', fontSize: '14px', margin: 0 }}>Tickets by Due Date</h4>
          </div>
        }
        ...
        content={
          <div>
            ...
            <p className='padding-15 nomargin uk-text-muted'>
              Please select the due dates and which groups to include in the report.
            </p>
...
export default ReportTicketsByDueDate
