...
import ReportTicketsByDueDate from 'containers/Reports/subreports/ticketsByDueDate'
                    ...
                    <ul style={{ margin: 0, padding: 0, listStyle: 'none' }}>
                      ...
                      <li>
                        <a
                          href='#'
                          className={'no-ajaxy'}
                          onClick={e => this.onSelectReportClicked(e, 'tickets_by_due_date')}
                        >
                          Tickets by Due Date
                        </a>
                      </li>
          ...
          <GridItem width={'3-4'} extraClass={'nopadding'}>
            <div style={{ padding: '15px 25px' }}>
              <div>
                ...
                {this.selectedReport === 'tickets_by_due_date' && <ReportTicketsByDueDate />}
              </div>
            </div>
          </GridItem>
        </Grid>
