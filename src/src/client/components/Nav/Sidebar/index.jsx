      ...
      >
        <div id={'side-nav-container'} style={{ minHeight: 'calc(100% - 50px)' }}>
          <ul className="side-nav">
            ...
            {sessionUser && Helpers.canUser('tickets:view') && (
              ...
              >
                <Submenu id="tickets">
                  ...
                  />
                  {sessionUser && ['pm', 'admin'].includes(sessionUser.role.normalized) && (
                    <SubmenuItem
                      text="Active"
                      icon="timer"
                      href="/tickets/active"
            ...
            /> */}
            {sessionUser &&
              ['pm', 'admin'].includes(sessionUser.role.normalized) &&
              Helpers.canUser('accounts:view') && (
                <SidebarItem
                  text="Accounts"
                  icon="&#xE7FD;"
                  href="/accounts"
            ...
            {sessionUser && ['pm', 'admin'].includes(sessionUser.role.normalized) && Helpers.canUser('groups:view') && (
              <SidebarItem
            ...
            {sessionUser && ['pm', 'admin'].includes(sessionUser.role.normalized) && Helpers.canUser('teams:view') && (
