module.exports = function (middleware, router, controllers) {
  ...
  router.get('/api/v2/childtickets/:uid', apiv2Auth, canUser('tickets:view'), apiv2.tickets.childrens);
  router.get('/api/v2/tickets/closedev/:parentid', apiv2Auth, canUser('tickets:view'), apiv2.tickets.canDevTicketClose);
  router.get('/api/v2/tickets/closeparent/:id', apiv2Auth, canUser('tickets:view'), apiv2.tickets.canParentTicketClose);
  ...
  router.get('/api/v2/teams/:gid', apiv2Auth, canUser('teams:view'), apiv2.teams.getGroupTeams);
