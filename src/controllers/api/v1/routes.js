...
module.exports = function (middleware, router, controllers) {
  ...
  router.post('/api/v1/tickets/createchild', apiv1, canUser('tickets:create'), apiCtrl.tickets.createChild);
  ...
  router.post('/api/v1/tickets/addquery', apiv1, canUser('comments:create'), apiCtrl.tickets.postQuery);
  ...
  router.post(genBaseUrl + 'tickets_by_due_date', apiv1, canUser('reports:create'), reportsGenCtrl.ticketsByDueDate);
