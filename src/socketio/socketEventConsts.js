...
exported.TICKETS_UI_TEAM_UPDATE = '$trudesk:tickets:ui:team:update';
exported.TICKETS_TEAM_SET = '$trudesk:tickets:team:set';
...
exported.TICKETS_ASSIGNEE_TEAM_LOAD = '$trudesk:tickets:assignee:team:load';
exported.TICKETS_GROUP_TEAM_LOAD = '$trudesk:tickets:group_team_load:load';
exported.TICKETS_TEAM_CLEAR = '$trudesk:tickets:tickets:team:clear';
...
exported.TICKETS_MARK_QUERY_AS_RESOLVED = '$trudesk:tickets:query_resolved:set';
