...
class TicketsContainer extends React.Component {
  ...
  render() {
    ...
    const headersList = [
      ...
      <TableHeader key={2} width={110} text={'Ticket ID'} />,
      <TableHeader key={3} width={'23%'} text={'Subject'} />,
      <TableHeader key={4} width={110} text={'Created'} />,
      <TableHeader key={7} text={'Assigned To'} />,
      <TableHeader key={8} width={110} text={'Due Date'} />,
      <TableHeader key={9} width={180} text={'Updated'} />,
      <TableHeader key={10} text={'Word Count'} />,
    ];

    if (this.props.sessionUser && ['pm', 'admin'].includes(this.props.sessionUser.role.normalized)) {
      headersList.push(
              ...
              this.props.tickets.map((ticket) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className={'vam nbb'}>{ticket.get('ticketID')}</TableCell>
                    ...
                    <TableCell className={'vam nbb'}>{ticket.get('wordCount')}</TableCell>
                    {this.props.sessionUser && ['pm', 'admin'].includes(this.props.sessionUser.role.normalized) && (
                      <>
