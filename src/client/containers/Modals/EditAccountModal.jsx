...
class EditAccountModal extends React.Component {
  ...
  componentDidMount() {
    ...
    this.wordCapacity=this.props.user.wordCapacity;
  ...
  onSubmitSaveAccount(e) {
    ...
    const data = {
      ...
      wordCapacity:this.wordCapacity
    };
        ...
        <div style={{ margin: '24px 24px 0 24px' }}>
          <form className="uk-form-stacked" onSubmit={(e) => this.onSubmitSaveAccount(e)}>
            ...
            <div className="uk-margin-medium-bottom">
              <label className="uk-form-label">Word Capacity</label>
              <input
                type="text"
                className={'md-input'}
                value={this.wordCapacity}
                onChange={(e) => this.onInputChanged(e, 'wordCapacity')}
              />
            </div>
            <div className="uk-margin-medium-bottom">
